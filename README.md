...
This project is a direct clone of https://github.com/Azure-Samples/app-service-msi-entityframework-dotnet - with no modifications/additions.

It's used purely as a reference application to have discussions as part of our interview process

The rest of the documentation is as per the project and included here for reference only.
